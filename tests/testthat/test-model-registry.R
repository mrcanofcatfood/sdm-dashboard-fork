test_that("model registry exposes the GLM backend", {
  ...
  expect_true("glm" %in% unname(sdm_model_choices()))
  expect_true("gam" %in% unname(sdm_model_choices()))
  expect_true("rangebag" %in% unname(sdm_model_choices()))
  expect_true("ensemble_glm_rangebag" %in% unname(sdm_model_choices()))
